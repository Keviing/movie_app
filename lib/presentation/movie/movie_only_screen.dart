...
import 'package:movie_app/presentation/provider/actor/actor_movie_respository.dart';
...
class MovieOnlyScreenState extends ConsumerState<MovieOnlyScreen> {
  ...
  void initState() {
    ...
    ref.read(listActor.notifier).getActorsMovie(widget.movieId);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _CustomActor(movieId: movie.id,),
      ],
    );
  }
}

class _CustomActor extends ConsumerWidget {
  final int movieId;
  const _CustomActor({required this.movieId});

  @override
  Widget build(BuildContext context, ref) {

    final actorByMovie = ref.watch(listActor);
